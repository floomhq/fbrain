...
def _profile_prompt(validated: dict, facts: dict, seed: str | None) -> str:
    ...
    return (
        ...
        "\n"
        "VOICE RULES:\n"
        "- Plain second-person ('You email Sam weekly about the release').\n"
        ...
        "The user will paste this into other AI sessions or send to collaborators who "
        "know nothing about them. Write in plain second-person. No corporate filler, no "
        "'passionate about', no 'pioneering'. Use their actual voice from their actual "
        "subjects.\n"
